...
<body>
 ...
 <ul class="dropdown-menu">
  ...
  <div class="container-md">
    ...
    <div class="profile-picture-container text-center mt-4">
    ...
    <form action="includes/update_profile-inc.php" method="post">
        ...
        <div class="mb-3">
          <label for="name" class="form-label">Username-changer</label>
          <input type="text" name="username" class="form-control" placeholder="Update your username">
        </div>

        <div class="mb-3">
          <label for="email" class="form-label">Email-changer</label>
          <input type="email" name="email" class="form-control" placeholder="Update your email">
        </div>

        <div class="mb-3">
          <label for="password" class="form-label">Password-changer</label>
          <input type="password" name="pwd" class="form-control" placeholder="Update your password">
        </div>

        <div class="mb-3">
          <label for="question" class="form-label">Secret Question</label>
          <input type="text" name="security_question" class="form-control" placeholder="What's your secret question?">
        </div>

        <div class="mb-3">
          <label for="answer" class="form-label">Answer</label>
          <input type="text" name="security_answer" class="form-control" placeholder="Enter your secret answer here">
        </div>
